...
const selectedClr = document.querySelector('.CP1 .selected-clr');
const angleIcon = document.querySelector('.CP1 .selected-clr .right i');
const selectClr = document.querySelector('.CP1 .select-clr');
const clrOptions = document.querySelector('.CP1 .clr-options');
const clrCode = document.querySelector('.CP1 .clr-code');
const selectedClrEl = document.querySelector('.CP1 .selected-clr .color');
const clrPicker = document.querySelector('.CP1 .picker span');
const clrInput = document.querySelector('.CP1 .picker input');
const randomClrBtn = document.querySelector('.CP1 #random-clr');
