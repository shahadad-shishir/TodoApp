...
export const colorPicker1 = {
  init() {
    ...
    clrOptions = document.querySelector('.CP1 .clr-options');
    clrCode = document.querySelector('.CP1 .clr-code');
    selectedClrEl = document.querySelector('.CP1 .selected-clr .color');
    clrPicker = document.querySelector('.CP1 .picker span');
    clrInput = document.querySelector('.CP1 .picker input');
    randomClrBtn = document.querySelector('.CP1 #random-clr');
    formEmojiIcon = document.querySelector('.EP1 .emoji');
